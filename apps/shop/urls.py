...
from apps.shop.views import ProductListView, Login, logout_view, Sign, ProductCreateView, ProductDetailView, \
    AddToCartView, CartView, remove_from_cart, PreorderView, paymenthandler, PreOrderListView
